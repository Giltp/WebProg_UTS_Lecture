    ...
    <div class="wrapper">
        ...
        <table class="tbl-30">
            <tr>
                <td>Nama: </td>
                <td>
                    <input type="text" name="nama" value="<?php echo $title; ?>">
                </td>
            </tr>
            ...
            <tr>
                <td>harga: </td>
                <td>
                    <input type="number" name="harga value="<?php echo $price; ?>">
                </td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="current_image" value="<?php echo $current_image; ?>">
